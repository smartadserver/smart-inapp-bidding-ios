...
typedef NS_ENUM(NSInteger, SASBidderAdapterCreativeRenderingType) {
    /// Smart SDK is responsible for rendering 3rd party ads.
    SASBidderAdapterCreativeRenderingTypePrimarySDK            = 0,
    
    /// Third party SDK, winning bidding competition is responsible for rendering the winning creative.
...
/// The winning creative ID, for reference
...
/// a Smart ad server DealID if any available
