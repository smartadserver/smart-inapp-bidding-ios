...
#define kSASSDKVersion						@"6.8"
#define kSASSDKRev                          @"313439"
...
/** Fetches an ad from Smart AdServer and create header bidding competition.
 ...
 and NO for the others (if you have more than one ad on the same page).
 @param target If you specified targets in the Smart AdServer manage interface, you can specify it here to target your advertisement.
 @param bidderAdapter The bidder adapter created from the result of the header bidding competition.
