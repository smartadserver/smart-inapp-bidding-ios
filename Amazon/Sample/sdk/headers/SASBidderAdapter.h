...
/**
 ...
 You can use it has the base class to create your own Header Bidding adapter.
...
/**
 ...
 @param sspName the name of the ssp that won the header bidding competition.
 @param winningCreativeID the unique identifier of the ad that won the header bidding competition.
 @param price the CPM value of the ad that won the header bidding competition.
 @param currency the CPM currency of the ad that won the header bidding competition.
